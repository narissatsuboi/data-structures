// Narissa Tsuboi
// ListInterface.h
// Specification file for ListInterface, the interface template for the ADT
// list that physical data structures like LinkedList can use to inherit
// core operations from.
// *Note, this file is from Lecture Code and has not been modified*
